...
export default {
  ...
  computed: {
    ...mapGetters(['movie']),
    asiaOceania: function() {
      return this.$store.state.main.asiaOceania
    },
  },
  ...
  methods: {
    ...
    getAsiaOceania: function() {
      storetmp.dispatch("getAsiaOceania") 
    },
    onSubmit(){

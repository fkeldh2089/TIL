    ...
    <div class="container d-flex justify-content-center ">
      <div class="d-flex flex-column justify-content-center" >
        <div class="d-flex justify-content-center">
          <div>
            <h3>많이 본 장르 기반 추천영화</h3>
          </div>
          <br>
          <v-btn 
              @click="getManyGenre">버튼
          </v-btn>
        </div>
        <br>
        <br>
...
export default {
  ...
  computed: {
    ...mapGetters(['movie']),
    manyGenre: function() {
      return this.$store.state.main.manyGenre
    },
  },
  ...
  methods: {
    ...
    getVoteGenre: function() {
      const currentUser = this.$store.state.accounts.currentUser
      storetmp.dispatch("getVoteGenre", currentUser)
    },
    ...mapActions([
      'fetchMovies',
      'updateSortingLevel',
